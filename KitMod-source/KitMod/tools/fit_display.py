#!/usr/bin/env python3
# Fixes Blockbench item models for vanilla Minecraft.
# 1) vanilla ignores "texture_size" (OptiFine only) - UVs must be in 0..16
# 2) "gui" saved without scale -> tall models overflow the slot and get cropped
...
def fix_uv(model):
    ...
    if biggest <= 16.001:
        return None    # already vanilla-correct
