...
public final class Abilities {
    ...
    private static boolean lavaCrystal(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.ITEM_FIRECHARGE_USE.value(),
    ...
    private static boolean rubyDiamond(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.BLOCK_AMETHYST_BLOCK_CHIME.value(),
    ...
    private static boolean rareGlove(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.ENTITY_PHANTOM_FLAP.value(),
    ...
    private static boolean enderIngot(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.ENTITY_ENDERMAN_TELEPORT.value(),
    ...
    private static boolean dragonIngot(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.ENTITY_ENDER_DRAGON_GROWL.value(),
    ...
    private static boolean bloodIngot(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.ENTITY_PLAYER_HURT.value(),
    ...
    private static boolean steel(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.BLOCK_ANVIL_LAND.value(),
                net.minecraft.sound.SoundCategory.PLAYERS, 0.5f, 1.6f);
    ...
    private static boolean reinforcedString(PlayerEntity player, World world) {
        ...
        world.playSound(null, player.getBlockPos(), SoundEvents.ENTITY_SPIDER_STEP.value(),
