...
public final class Mechanics {
        ...
        AttackEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            ...
            if (stack.isOf(ModItems.PIZZA_SWORD)) {
                if (tryUse(player, "pizza_sword", KitMod.CONFIG.pizzaSwordCooldown)) {
                    ...
                    play(world, player.getBlockPos(), SoundEvents.ENTITY_PLAYER_BURP.value(), 0.6f, 1.4f);
                }
    ...
    private static void legendarySword(World world, Entity target) {
        ...
        play(world, victim.getBlockPos(), SoundEvents.BLOCK_BEACON_DEACTIVATE.value(), 0.6f, 1.8f);
    }
    ...
    private static void scythe(PlayerEntity player, World world, Entity target) {
        ...
        play(world, player.getBlockPos(), SoundEvents.ENTITY_WITCH_DRINK.value(), 0.7f, 0.7f);
        ...
        drain(victim, amount);
        play(world, player.getBlockPos(), SoundEvents.ENTITY_WITHER_HURT.value(), 0.8f, 1.6f);
    ...
    private static void registerLavaMold() {
        UseBlockCallback.EVENT.register((player, world, hand, hitResult) -> {
            ...
            if (state.isOf(ModBlocks.LAVA_MOLD) && stack.isOf(Items.LAVA_BUCKET)) {
                ...
                play(world, pos, SoundEvents.ITEM_BUCKET_EMPTY_LAVA.value(), 1.0f, 1.0f);
                return ActionResult.SUCCESS;
            }
            ...
            if (state.isOf(ModBlocks.LAVA_MOLD_FILLED) && stack.isOf(Items.BUCKET)
                ...
                play(world, pos, SoundEvents.ITEM_BUCKET_FILL_LAVA.value(), 1.0f, 1.0f);
                return ActionResult.SUCCESS;
            }
